...
Os dados ficam no `localStorage` do navegador nesta primeira etapa. A tela de planejamento permite exportar e importar cada plano em JSON. Essa camada foi isolada no início de `app.js` para facilitar a futura substituição por Supabase.
